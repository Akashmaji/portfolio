    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          Hello,<br/>
          I'm <span className="purple">Akash Maji</span>, currently in the <spam className="purple">Third year of my Integrated B.E in Information Technology at AISSMS IOIT, Pune</spam>. While my academic focus lies in IT, I'm equally passionate about diverse pursuits.
          <br/><br/>
